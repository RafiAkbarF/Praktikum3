...
var tourismPlaceList = [
  TourismPlace(
    ...
    time: '10.00 - 21.00',
    price: 'Free',
    description: 'Jalan Tunjungan semenjak awal abad ke-20 telah menjadi  '
        'salah satu pusat komersial Kota Surabaya. Jalan ini adalah jalan '
        'penghubung yang sekali menjadi daerah pertokoan utama di Surabaya. '
        'Jalan tersebut menghubungkan derah perumahan disebelah '
        'Selatan-Timur & Barat Surabaya (Gubeng, Darmo, Ketabang dan Sawahan), '
        'dengan daerah perdagangan yang ada disekitar Jembatan Merah. '
        'Disepanjang Jalan Tunjungan terdapat berbagai macam toko dan restoran. '
        'begitu indah. Kemudian di desain sedemikian rupa agar terlihat '
        'Salah satunya adalah bangunan pertokoan dan restaurant "HELLENDORN" '
        'dipojok Jl. Kenari dan Jl. Tunjungan.Perancangnya adalah Ir. Th. Van Oyen ',
  ),
  TourismPlace(
    name: 'Kelenteng Sanggar Agung Kenjeran',
    title: 'Kelenteng Sanggar Agung Kenjeran',
    ...
    time: '08.00 - 18.00',
    price: 'IDR 10.000',
    description: 'Kelenteng Sanggar Agung atau Klenteng Hong San Tang adalah '
        'sebuah klenteng di Kota Surabaya. Alamatnya berada di Jalan '
        'Sukolilo Nomor 100, Pantai Ria Kenjeran, Surabaya. Kuil ini, selain '
        'menjadi tempat ibadah bagi pemeluk Tridharma, juga menjadi '
        'tempat tujuan wisata bagi para wisatawan.  '
        'Kuil ini, selain menjadi tempat ibadah bagi pemeluk Tridharma,  '
        'juga menjadi tempat tujuan wisata bagi para wisatawan.  '
        'Klenteng ini dibuka pada tahun 1999.Ciri khas klenteng ini adalah '
        ' sebuah patung Kwan Im setinggi 20 meter yang terletak di tepi laut. ',
  ),
  TourismPlace(
    name: 'JatimPark 3',
    title: 'JatimPark 3',
    ...
    price: 'IDR 150,000',
    description:
        'Wisata Jatim Park 3 ini memiliki wahana-wahana yang seru '
        'di antaranya: Dino Mall,Life with Dino,Aquarium 4 Dimensi,The Rimba, '
        'dan lain-lain. Selain wahana serba Dinosaurus,ada juga wahana lainnya '
        'yang menjadi favorit bagi para pengunjung,yaitu bernama Invinity. '
        'Wahana ini menawarkan keunikan berupa Rumah Kaca. '
        'Jadi, kamu bisa melihat bayangan yang unik dan aneh di sana. '
        'Tentunya, ini juga menjadi spot selfie yang sangat keren. '
        'Adapun wahana lainnya yang tak kalah seru, antara lain  '
        'adalah Music Gallery, Gedung Teater, Red Carpet, dan Hi-Tech Multimedia. '
        'Masih banyak lagi yang lainnya. Agar lebih seru, sebaiknya langsung saja datang ke lokasi !',
  ),
  TourismPlace(
  ...
  TourismPlace(
    ...
    description:
        ...
        'Sebagai sebuah objek wisata, Bromo menjadi menarik karena statusnya '
        'sebagai gunung berapi yang masih aktif. Gunung Bromo  '
        ...
        'Ia mempunyai sebuah kawah dengan garis tengah ± 800 meter (utara-selatan) '
        'dan ± 600 meter (timur-barat). Sedangkan daerah bahayanya '
